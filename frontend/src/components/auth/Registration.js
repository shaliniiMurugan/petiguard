...
const Registration = () => {
    ...
    const getMaxLength = (type) => {
      ...
      const handleChange = (e) => {
        ...
        // Max length check for government ID number
        if (name === "governmentIdNumber") {
            const max = getMaxLength(formData.governmentIdType || "default");
            if (value.length > max) {
                updatedErrors[name] = `Maximum ${max} characters allowed`;
            } else {
                updatedErrors[name] = '';
            }
        }
        ...
        if (name !== "governmentIdNumber" && errors[name]) {
            updatedErrors[name] = '';
        }
                ...
                <>
                    ...
                    <div className="form-group">
                        ...
                        <select
                            ...
                            onChange={handleChange}
                            maxLength={getMaxLength(formData.governmentIdType)}
